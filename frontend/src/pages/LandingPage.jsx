  ...
  <div className={landingPageStyles.heroGrid}>
    ...
    <div className={landingPageStyles.heroLeft}>
      <div className={landingPageStyles.tagline}>
        The Purr-fect Resume Builder
      </div>

      <h1 className={landingPageStyles.heading}>
        <span className={landingPageStyles.headingText}>Craft🐾</span>
        <span className={landingPageStyles.headingGradient}>Pawsome </span>
          ...
          <button className={landingPageStyles.primaryButton}
            onClick = {handleCTA}>
              ...
              <span className={landingPageStyles.primaryButtonContent}>
                Start Building
                <ArrowRight className={`${landingPageStyles.primaryButtonIcon} animate-bounce ml-1 text-pink-400`}/>
              </span>
          </button>
        ...
        <div className={landingPageStyles.statsContainer}>
          {[
            { value: '50K+', label: 'Resumes Created', gradient: 'from-rose-600 to-cyan-500' },
            { value: '4.9★', label: 'User Rating', gradient: 'from-cyan-500 to-red-500' },
            { value: '5 Min', label: 'Build Time', gradient: 'from-rose-500 to-cyan-500' }
          ].map((stat, idx) => (
            ...
            <div className={landingPageStyles.featuresContainer}>
              <div className= {landingPageStyles.featuresHeader}>
                ...
                <p className={landingPageStyles.featuresDescription}>
                  Everything you need to create a stunning resume in one place.
                </p>
        ...
        <footer className={landingPageStyles.footer}>
          <div className={landingPageStyles.footerContainer}>
            <p className={landingPageStyles.footerText}>
              ...
              <a href="https://www.linkedin.com/in/chhavi-gautam/" target ='_blank' className={landingPageStyles.footerLink}>
              Chhavi Gautam</a>
            </p>
          </div>
        </footer>

      {/* MODAL FRO LOGIN AND SIGNUP */}
