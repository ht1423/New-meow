...
const ThemeSelector = ({selectedTheme,  setSelectedTheme, resumeData, onClose} ) => {
  ...
  return (
    <div className=' max-w-7xl mx-auto px-4'>
      {/* header */}
      <div className=' flex felx-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8
      ...
      <div className=' grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
          <div className=' lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6'>
            <div className=' grid grid-cols-1 sm:grid-cols-2 gap-4 max-4 max-h-[60vh] lg:max-h-[70vh]
            overflow-auto p-2'>
