...
import { Award, Check, Clock, Dice1, Edit, Trash2, TrendingUp, Zap } from "lucide-react"
...
export const TemplateCard = ({thumbnailImg, isSelected, onSelect}) => {
  return (
    ...
    ${isSelected ? 'border-violet-500 shadow-lg shadow-lg shadow-violet-500/20 bg-violet-50'
