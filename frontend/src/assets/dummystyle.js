export const landingPageStyles = {
  // Main container
container: "min-h-screen overflow-x-hidden bg-gradient-to-br from-black via-gray-900 to-pink-900",

  // Header styles
header: "fixed top-0 w-full z-50 bg-black/70 backdrop-blur-xl border-b border-pink-500/20",
...
logoIcon: "w-10 h-10 bg-gradient-to-br from-pink-600 to-rose-600 rounded-2xl flex items-center justify-center shadow-lg shadow-pink-800/40",
  logoIconInner: "w-5 h-5 text-white",
logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-pink-400 to-orange-300 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-violet-50 transition-colors",
mobileMenuIcon: "text-rose-600",

  // Auth buttons
desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-rose-300",
desktopAuthButtonText: "relative text-white",
desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-rose-600 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity",
mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-rose-200/50 transition-all",

  // Mobile menu
  // Mobile menu
  // Mobile menu
mobileMenu: "md:hidden bg-black/90 backdrop-blur-lg w-full fixed top-16 left-0 right-0 z-40 shadow-lg border-b border-pink-300/20 transition-all duration-300 ease-in-out",
...
heroGrid: "flex flex-col lg:flex-row items-center justify-between gap-10 w-full",
  heroLeft: "space-y-8",
tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-rose-100 to-pink-100 border border-rose-200 text-rose-700 rounded-full font-bold text-xs sm:text-sm",
  heading: "text-4xl sm:text-6xl lg:text-8xl font-black leading-tight",
headingText: "block text-white",
headingGradient: "block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 bg-clip-text text-transparent",
description: "text-base sm:text-lg lg:text-xl text-pink-100 leading-relaxed max-w-lg font-medium",
  ctaButtons: "flex flex-col sm:flex-row gap-4",

  // Buttons
primaryButton: "group relative px-10 py-4 bg-gradient-to-r from-rose-600 to-pink-500 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-rose-200",
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-pink-600 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity",
...
secondaryButton: "px-8 sm:px-10 py-3 sm:py-4 border-2 border-rose-300 text-rose-600 font-bold rounded-2xl hover:border-rose-400 hover:bg-rose-50 transition-all",
  ...
  // Features section
featuresSection: "bg-gradient-to-br from-gray-950 via-black to-rose-800 py-16 sm:py-24",
  featuresContainer: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8",
  featuresHeader: "text-center mb-12 sm:mb-20",
  featuresTitle: "text-3xl sm:text-4xl lg:text-5xl font-black text-pink-900 mb-4 sm:mb-6",
...
featuresGrid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mt-12",
  ...
  ctaButton: "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-pink-700/40",
  ...
  // Footer
footer: "bg-gradient-to-br from-black via-gray-900 to-pink-900 text-white py-8",
...
export const dashboardStyles = {
  ...
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-pink-700/40",
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-blue-50 border-2 border-dashed border-rose-400 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-violet-500 h-full",
...
export const cardStyles = {
  ...
  logoutButton: "text-rose-500 text-[10px] sm:text-xs font-bold cursor-pointer hover:text-fuchsia-600 transition-colors",

  // ResumeSummaryCard styles
  resumeCard: "group relative h-[360px] sm:h-[380px] lg:h-[400px] flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02]  hover:border-rose-400",
  ...
  title: "text-sm sm:text-base font-bold text-gray-800 truncate mb-2 group-hover:text-rose-500 transition-colors",
...
export const authStyles = {
  ...
  submitButton: "w-full py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-pink-800 hover:shadow-pink-700/40 transition-all text-lg",
  switchText: "text-center text-sm text-slate-600 font-medium",
  switchButton: "font-black text-rose-500 hover:text-fuchsia-600 transition-colors",
  ...
  signupSubmit: "w-full py-4 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-pink-800 hover:shadow-rose-200 transition-all text-lg",
...
export const buttonStyles = {
  theme: "flex items-center gap-2 px-3 sm:px-4 py-2 bg-violet-100 text-rose-600 font-bold rounded-xl hover:bg-violet-200 transition-all",
...
export const statusStyles = {
  ...
  modalBadge: "inline-flex items-center gap-2 bg-violet-100 px-3 py-1 rounded-full text-sm font-medium text-rose-600",
...
export const inputStyles = {
  wrapper: "mb-6 group",
  label: "block text-sm font-bold text-gray-800 mb-3 group-focus-within:text-rose-500 transition-colors",
  ...
  toggleButton: "text-gray-500 hover:text-rose-500 transition-colors p-1 rounded-lg hover:bg-gray-100",
};
...
export const titleInputStyles = {
  ...
  editIcon: "w-5 h-5 text-gray-600 group-hover:text-rose-500 transition-colors",
